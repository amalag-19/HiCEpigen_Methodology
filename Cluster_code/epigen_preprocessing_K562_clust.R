...
df_epigen<-fread(input = "/storage/home/a/aua257/work/Bio_Stat/penalized_full_models/data/K562_ENCODE36.bigBed",data.table = F)
...
# ## saving the states
# save(states,file="/Users/Amal/Box Sync/PSU/Fall 2018/BioStat_Research/Data/Epigenetic/states_K562.RData")
...
save(df_epigen_output,file="/storage/home/a/aua257/work/Bio_Stat/penalized_full_models/results/df_epigen_output_K562.RData")
